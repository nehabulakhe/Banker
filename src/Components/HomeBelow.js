  ...
  return (
    <div className='Home-below'>
      <div className="container ">
        ...
        <div className="row">
          <div className="col-md-6 mb-5 center aos-init" data-aos="fade-up" data-aos-delay="">
              <figure className="circle-bg">
                <img src={img1} alt="" className="img-fluid" />
              </figure>
          </div>
          <div className="col-lg-5 ml-auto aos-init" data-aos="fade-up" data-aos-delay="100">
            <div className="mb-4">
